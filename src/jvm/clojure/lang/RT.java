...
static final Var QDEF_VAR = Var.intern(CLOJURE_NS, Symbol.intern("def"));
static final Var QLOOP_VAR = Var.intern(CLOJURE_NS, Symbol.intern("loop*"));
static final Var QRECUR_VAR = Var.intern(CLOJURE_NS, Symbol.intern("recur"));
static final Var QIF_VAR = Var.intern(CLOJURE_NS, Symbol.intern("if"));
static final Var QCASE_VAR = Var.intern(CLOJURE_NS, Symbol.intern("case*"));
static final Var QLET_VAR = Var.intern(CLOJURE_NS, Symbol.intern("let*"));
static final Var QLETFN_VAR = Var.intern(CLOJURE_NS, Symbol.intern("letfn*"));
static final Var QDO_VAR = Var.intern(CLOJURE_NS, Symbol.intern("do"));
static final Var QFN_VAR = Var.intern(CLOJURE_NS, Symbol.intern("fn*"));
static final Var QQUOTE_VAR = Var.intern(CLOJURE_NS, Symbol.intern("quote"));
static final Var QTHE_VAR_VAR = Var.intern(CLOJURE_NS, Symbol.intern("var"));
static final Var QIMPORT_VAR = Var.intern(CLOJURE_NS, Symbol.intern("import*"));
static final Var QDOT_VAR = Var.intern(CLOJURE_NS, Symbol.intern("."));
static final Var QASSIGN_VAR = Var.intern(CLOJURE_NS, Symbol.intern("set!"));
static final Var QDEFTYPE_VAR = Var.intern(CLOJURE_NS, Symbol.intern("deftype*"));
static final Var QREIFY_VAR = Var.intern(CLOJURE_NS, Symbol.intern("reify*"));
static final Var QTRY_VAR = Var.intern(CLOJURE_NS, Symbol.intern("try"));
static final Var QTHROW_VAR = Var.intern(CLOJURE_NS, Symbol.intern("throw"));
static final Var QMONITOR_ENTER_VAR = Var.intern(CLOJURE_NS, Symbol.intern("monitor-enter"));
static final Var QMONITOR_EXIT_VAR = Var.intern(CLOJURE_NS, Symbol.intern("monitor-exit"));
static final Var QCATCH_VAR = Var.intern(CLOJURE_NS, Symbol.intern("catch"));
static final Var QFINALLY_VAR = Var.intern(CLOJURE_NS, Symbol.intern("finally"));
static final Var QNEW_VAR = Var.intern(CLOJURE_NS, Symbol.intern("new"));
